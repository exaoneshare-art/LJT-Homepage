...
- **On the Perception Bottleneck of VLMs for Chart Understanding** (2025). Junteng Liu, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. *Arxiv*. (First author; code available on GitHub: Vision4Chart)
- **On the Universal Truthfulness Hyperplane Inside LLMs** (EMNLP 2024). Junteng Liu, Shiqi Chen, Yu Cheng, Junxian He. (First author; code available on GitHub: Universal_Truthfulness_Hyperplane)
